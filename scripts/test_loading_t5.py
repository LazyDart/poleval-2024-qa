...
tokenizer, model = load_plt5(large=False, colab=False)
...
print(sequences)
# Result: ['<pad> 規, że nie ma przyjaciół."......沪 wie o tym wszystko lepiej niż ktokolwiek浑[䀀,残 po prostu się pomyliła!</s>'] <- This is not a valid polish sentence